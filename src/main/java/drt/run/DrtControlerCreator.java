...
import drt.analysis.DrtAnalysisModule;
import drt.optimizer.DefaultDrtOptimizerProvider;
import drt.optimizer.DrtOptimizer;
import drt.passenger.DrtRequestCreator;
import drt.routing.*;
import drt.vrpagent.DrtActionCreator;
	...
	public static Controler createControler(Config config, boolean otfvis) {
		...
		controler.addOverridingModule(new AbstractModule() {
			...
			public void install() {
				...
				addRoutingModuleBinding(DrtConfigGroup.DRT_MODE).to(InterModalDrtRoutingLessTransitModule.class).asEagerSingleton();
